...
public class AccountService : IAccountService
{
    ...
    private readonly IActiveUserTrackerRepositoryAsync _activeUserTrackerRepositoryAsync;
    ...
    public AccountService(UserManager<ApplicationUser> userManager,
        ...
        IActiveUserTrackerRepositoryAsync activeUserTrackerRepositoryAsync,
        IJwtBlacklistService jwtBlacklistService)
    {
        ...
        _activeUserTrackerRepositoryAsync = activeUserTrackerRepositoryAsync;
    ...
    public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
    {
        ...
        await _activeUserTrackerRepositoryAsync.LoginActiveUserTracker(user.Id, request.Email, new JwtSecurityTokenHandler().WriteToken(jwtSecurityToken));
    ...
    public async Task Logout(string userId, string email, string token)
    {
        if (token != null)
        {
            _jwtBlacklistService.AddToBlacklist(token);

            await _activeUserTrackerRepositoryAsync.LoggOutActiveUserTracker(userId, email, token);
        }
